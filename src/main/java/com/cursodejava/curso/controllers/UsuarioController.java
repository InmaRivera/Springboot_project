...
public class UsuarioController {
    ...
    public Usuario getUsuario(@PathVariable Long id) {
        ...
        usuario.setId(id);
        usuario.setNombre("Inma");
        usuario.setApellidos("Rivera");
        usuario.setEmail("conchi.rp94@gmail.com");
        usuario.setTelefono("3478947389");
        return usuario;
    }
    ...
    public void eliminar(@PathVariable Long id){ usuarioDao.eliminar(id);}
